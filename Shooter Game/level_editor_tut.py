...
save_img = pygame.image.load('files/img/save_btn.png').convert_alpha()
load_img = pygame.image.load('files/img/load_btn.png').convert_alpha()
...
while run:
	...
	if load_button.draw(screen):
		...
		scroll = 0
		with open(f'csv/level{level}_data.csv', newline='') as csvfile:
